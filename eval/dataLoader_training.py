        ...
        if 'ETT' in self.dataset_name:
            for attr in self.meaning.keys():
                if self.dataset_name == 'ETTh1' or self.dataset_name == 'ETTh2':
                    data = original_data[0: 12 * 30 * 24 - self.look_back]
                else:
                    data = original_data[0: 12 * 30 * 24 * 4 - self.look_back]
            ...
            data_progress = original_data[0:num_train - self.look_back]
            ...
            for attr in self.meaning.keys():
                ...
                num_train = int(len(original_data) * 0.7)
                num_test = int(len(original_data) * 0.2)
                data_gt = original_data[0:num_train]
