    ...
    def fit(self):
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                if self.config.debug:
                    breakpoint() #batch_dict[input_ids].shape = (192,3072)
                metrics = {}
                ...
                with _timer('step', timing_raw):
                    ...
                    if self.config.debug:
                        breakpoint()  # input_ids.shape = attention_mask.shape = (192,3072),prompts = responses = (192 * 8,3072)
                    ...
                    # repeat to align with repeated responses in rollout + breakpoint()
